...
public class FragmentDashboard extends Fragment {
    TextView textCases, textDeaths,textRecovered, textUpdated, textActive,
            textCountry, textTodayDeaths, textTodayCases, textTest,
            textCritical, textCasesperMillion, textDeathsPerMillion, textTestPerMillion;
    ImageView imgFlag;
    ...
    private void initComponents(View view){
        ...
        textTodayCases = view.findViewById(R.id.textTodayCases);
        textTodayDeaths = view.findViewById(R.id.textTodayDeaths);
        textTest = view.findViewById(R.id.textTest);
        textCasesperMillion = view.findViewById(R.id.textCasesPerMillion);
        textDeathsPerMillion = view.findViewById(R.id.textDeathsPerMillion);
        textTestPerMillion = view.findViewById(R.id.textTestPerMillion);
        textCritical = view.findViewById(R.id.textCritical);
        imgFlag = view.findViewById(R.id.imgFlag);
        progressBar = view.findViewById(R.id.progress_bar);
    }

    private String getCountryNameFromActivity(){
        Intent intent = getActivity().getIntent();
        String country = "/" + intent.getStringExtra("country");
        return country;
    }

    private void displayCountryInfo(final View view){
        StringRequest request = new StringRequest(Request.Method.GET,
                URLS.displayCountries + getCountryNameFromActivity(),
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            int casesPerMillion = object.getInt("casesPerOneMillion");
                            int deathsPerMillion = object.getInt("deathsPerOneMillion");
                            int testsPerMillion = object.getInt("testsPerOneMillion");
                            int critical = object.getInt("critical");
                            long updated = object.getLong("updated");

                            textCountry.setText(country);

                            startCountryCountAnimation(cases, deaths, recovered, active, todayCases,
                                                       todayDeaths, test, casesPerMillion,
                                                       deathsPerMillion, testsPerMillion, critical);

                            textUpdated.setText(toDate(updated));
                            Picasso.with(getActivity()).load(flagURL).fit().centerInside().into(imgFlag);

                            initLineChart(view);
                            initBarChart(view, cases, active, deaths, recovered);
    ...
    private void startCountryCountAnimation(final int cases, final int deaths, final int recovered, final int active,
                                              final int todayCases, final int todayDeaths, final int test, final int casesPerMillion,
                                              final int deathsPerMillion, final int testsPerMillion, final int critical) {
        ...
        ValueAnimator animator5 = ValueAnimator.ofInt(0, todayCases);
        ValueAnimator animator6 = ValueAnimator.ofInt(0, todayDeaths);
        ValueAnimator animator7 = ValueAnimator.ofInt(0, test);
        ValueAnimator animator8 = ValueAnimator.ofInt(0, casesPerMillion);
        ValueAnimator animator9 = ValueAnimator.ofInt(0, deathsPerMillion);
        ValueAnimator animator10 = ValueAnimator.ofInt(0, testsPerMillion);
        ValueAnimator animator11 = ValueAnimator.ofInt(0, critical);
        ...
        animator5.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                textTodayCases.setText(decimalFormatter((int)animation.getAnimatedValue()));
            }
        });
        animator5.start();
        ...
        animator6.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                textTodayDeaths.setText(decimalFormatter((int)animation.getAnimatedValue()));
            }
        });
        animator6.start();
        ...
        animator7.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                textTest.setText(decimalFormatter((int)animation.getAnimatedValue()));
            }
        });
        animator7.start();
        ...
        animator8.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                textCasesperMillion.setText(decimalFormatter((int)animation.getAnimatedValue()));
            }
        });
        animator8.start();
        ...
        animator9.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                textDeathsPerMillion.setText(decimalFormatter((int)animation.getAnimatedValue()));
            }
        });
        animator9.start();

        animator10.setDuration(2000);
        animator10.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                textTestPerMillion.setText(decimalFormatter((int)animation.getAnimatedValue()));
            }
        });
        animator10.start();

        animator11.setDuration(2000);
        animator11.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
    ...
    private void initLineChart(View view){
        ...
        String sCountryName = getCountryNameFromActivity().toLowerCase().trim();
        StringRequest request = new StringRequest(Request.Method.GET,
                URLS.displayCountryTimeline + sCountryName,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            JSONObject object = new JSONObject(response).getJSONObject("timeline");
    ...
    private void initBarChart(View view, int cases, int active, int deaths, int recovered){
        BarChart chart = view.findViewById(R.id.barchart);
        ArrayList dataList = new ArrayList();

        dataList.add(new BarEntry(cases, 0));
        dataList.add(new BarEntry(active, 1));
        dataList.add(new BarEntry(deaths, 2));
        dataList.add(new BarEntry(recovered, 3));
        ...
        int[] colors = new int[] {Color.parseColor("#63B5F6"),
